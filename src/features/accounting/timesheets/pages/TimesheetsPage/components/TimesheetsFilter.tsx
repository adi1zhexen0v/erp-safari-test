...
interface Props {
  ...
  onStatusChange: (v: "draft" | "approved" | null) => void;
...
export default function TimesheetsFilter({
  search,
  onSearchChange,
  dateRange,
  onDateRangeChange,
  ...
  function handleStatusChange(v: "draft" | "approved" | null) {
    onStatusChange(v);
  }
