export interface PremisesHandoverAct {
  id: number;
...
export interface PremisesHandoverListResponse {
  count: number;
  next: string | null;
  previous: string | null;
  results: PremisesHandoverAct[];
}

export type PremisesHandoverResponse = PremisesHandoverAct;
...
export interface PremisesHandoverApiPayload {
  parent_contract: number;
  act_date?: string;
}
